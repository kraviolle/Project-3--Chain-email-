						...
						if (event.keyCode == 38) {
							...
							if (city_level.active) {
								...
								else if((city_level.player_position.x == 7 && city_level.player_position.y == 3))
								{
									...
									Outside.active = true;
									Outside.player_direction = 3;
									npc_controller.decompress(level2.buildingTwo);
									level2.playerLocation = 3;
								}
								else if((city_level.player_position.x == 11 && city_level.player_position.y == 3))  
								{
									...
									Outside.active = true;
									Outside.player_direction = 3;
									npc_controller.decompress(level2.buildingThree);
									level2.playerLocation = 4;
								}
								else if((city_level.player_position.x == 3 && city_level.player_position.y == 7))  
								{
									...
									Outside.active = true;
									Outside.player_direction = 3;
									npc_controller.decompress(level2.buildingFour);
									level2.playerLocation = 5;
								}
						...
						if (event.keyCode == 90){
							...
							if(Outside.active)//If outside
							{
								if(Outside.player_position.y != 0 && Outside.player_direction == 1 && Outside.map[Outside.player_position.x][Outside.player_position.y - 1].occupied)// If facing up and NPC there
								{
									...
									{
										alert(npc_controller.NPC_array[Outside.map[Outside.player_position.x][Outside.player_position.y - 1].npc].message);
								...
								if(Outside.player_position.x != 0 && Outside.player_direction == 3 && Outside.map[Outside.player_position.x - 1][Outside.player_position.y].occupied) // If facing left and NPC left
								{
									...
									{
										alert(npc_controller.NPC_array[Outside.map[Outside.player_position.x - 1][Outside.player_position.y].npc].message);
									}
								}
							...
							if(lobby.active)//If inside
							{
								if(lobby.player_position.y != 0 && lobby.player_direction == 1 && lobby.map[lobby.player_position.x][lobby.player_position.y - 1].occupied)// If facing up and NPC there
								{
									...
									{
										alert(npc_controller.NPC_array[lobby.map[lobby.player_position.x][lobby.player_position.y - 1].npc].message);
									}
								}
								...
								if(lobby.player_position.x != 0 && lobby.player_direction == 3 && lobby.map[lobby.player_position.x - 1][lobby.player_position.y].occupied) // If facing left and NPC left
								{
									...
									{
										alert(npc_controller.NPC_array[lobby.map[lobby.player_position.x - 1][lobby.player_position.y].npc].message);
									}
								}
